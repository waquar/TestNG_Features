...
public class ExceltoMapinList {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
		...
		List<LinkedHashMap<String, String>> mapDataList = getExcelDataAsMap(filelocation,"UserAccounts");
		...
		System.out.println(mapDataList.toString());
	}
